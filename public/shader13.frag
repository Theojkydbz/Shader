...
void main() {
    ...
    circlePos += vec2(sin(circlePos.x * 5. + noiseOffset.x * 50.0 + u_time * 8.0),
                      sin(circlePos.y * 5. + noiseOffset.y * 50.0 + u_time * 8.0)) * 0.06;
    ...
    float black = step(dist, circleSize / 0.05);
